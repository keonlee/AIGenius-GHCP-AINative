...
Copilot을 아주 빠르고, 매우 직역적이며, 명확한 지시가 필요한 신입 개발자로 생각해보세요. 여러분은 그의 작업을 버리고 스스로 다시 쓰는 것이 아니라, 피드백을 주어 개선하도록 하는 것입니다.
...
여러분은 개발 팀장으로서 무엇을, 왜 만들지 정의했습니다. Copilot은 단지 기능 구현을 맡았습니다. 여러분은 결과를 검증하고 완성까지 이끌었습니다.

그것이 바로 AI-Native 개발 방법입니다.
